...
commands = [
    "apt-get update && apt-get install -y git mono-devel msbuild nuget",
    "mkdir -p /root/source",
    "cd /root/source && git init && git remote add origin https://github.com/oven-ttta/Clash-Of-SL.git || true",
    "cd /root/source && git fetch --all && git reset --hard origin/main",
    "cd /root/source/'Clash SL Server' && nuget restore 'Clash SL Server.sln'",
